...
import P3 from "../assets/P3 - Copy.png"
        ...
        <div>
            ...
            <div className='flex items-center justify-center'>
                <div className="w-full sm:w-1/2 flex-col justify-center">
                    ...
                    <h2 className='text-4xl md:text-7xl font-bold text-orange-400 py-2'>Joshua Suriyan</h2>
                    <img src={js} className='w-50 block sm:hidden' alt="Blog Profile Image" />
                    ...
                    <button className='button-style mt-2' onClick={() => window.location.href = "mailto:joshuasuriyan05@gmail.com"}>Hire Me</button>
                </div>
                <div className='justify-center hidden sm:block'>
                    <img src={js} className='w-60 md:w-96 ' alt="Blog Profile Image" />
